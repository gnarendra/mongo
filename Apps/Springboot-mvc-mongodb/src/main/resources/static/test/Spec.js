...
describe('person for curd operations', function () {
	  var UserService,
	      httpBackend;
	  ...
	  it('get person spec.', function (){
	    // set up some data for the http call to return and test later.
	    var returnData = { excited: true };
	    
	    // expectGET to make sure this is called once.
	    httpBackend.expectGET('/person/personlist').respond(returnData);
	  ...
	  it('delete person spec', function (){
		    // set up some data for the http call to return and test later.
		    var returnData = { excited: true };
		    
		    // expectGET to make sure this is called once.
		    httpBackend.expectGET('/person/deletePerson?id=1').respond(returnData);
	  ...
	  it('Edit person Spec.', function (){
		    // set up some data for the http call to return and test later.
		    var returnData = { excited: true };
		    
		    // expectGET to make sure this is called once.
		    httpBackend.expectPOST('/person/editPerson?id=1&firstName=test&lastName=test').respond(returnData);
		    var user = {
					"firstName": "test",
					"lastName": "test"
				};
	  ...
	  it('Add person Spec.', function (){
		    // set up some data for the http call to return and test later.
		    var returnData = { excited: true };
		    
		    // expectGET to make sure this is called once.
		    httpBackend.expectPOST('/person/addPerson?firstName=test&lastName=test').respond(returnData);
		   var user = {
					"firstName": "test",
					"lastName": "test"
				};
