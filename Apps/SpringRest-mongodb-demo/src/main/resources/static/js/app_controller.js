...
App.controller('AppController', ['$scope', 'UserService', function($scope, UserService) {
        ...
        self.deleteUser = function(id){
          ...
          self.createUser = function(user){   console.log('createUser'); 
          ...
          self.submit = function() {
              ...
              if(self.user.id===null){
                  console.log('Saving New User', self.user,self.user.id,self.user.taskName);    
       ...
       self.edit = function(id){
        ...
        self.reset = function(){
        	self.user={id:null,title:'',artist:'',releaseYear:''};
        }
