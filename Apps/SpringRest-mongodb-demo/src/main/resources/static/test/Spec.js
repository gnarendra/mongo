...
describe('task specs for curd operations', function () {
	  var UserService,
	      httpBackend;
	  ...
	  it('delete task spec', function (){
		    // set up some data for the http call to return and test later.
		    var returnData = { excited: true };
		    
		    // expectGET to make sure this is called once.
		    httpBackend.expectGET('/deleteTask?id=1').respond(returnData);
	  ...
	  it('Edit task Spec.', function (){
		    // set up some data for the http call to return and test later.
		    var returnData = { excited: true };
		    
		    // expectGET to make sure this is called once.
		    httpBackend.expectPOST('/editTask?id=1&taskName=test').respond(returnData);
		   var user ={
					"taskName": "test"
	  ...
	  it('Add task Spec.', function (){
		    // set up some data for the http call to return and test later.
		    var returnData = { excited: true };
		    
		    // expectGET to make sure this is called once.
		    httpBackend.expectPOST('/createTask?taskName=test').respond(returnData);
		   var user = {
					"taskName": "test"
